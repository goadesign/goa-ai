...
| [Standalone JSON codecs](docs/json_codecs.md) | Select an existing named Goa type and generate typed encode/decode functions that validate the original value and reject ambiguous or invalid JSON. |
