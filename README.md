...
| [Tool registries](docs/dsl.md#registry) | Host a clustered registry for tool discovery and invocation. Load schema-based provider toolsets at startup and pass immutable definitions into generated agents. |
