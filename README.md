...
- Gemini function declarations omit only validation and annotation keywords
  that Vertex does not accept. The validated client still applies the complete
  canonical schema to every returned tool call; unknown structural keywords
