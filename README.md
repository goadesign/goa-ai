...
For Anthropic models on Bedrock, the adapter uses one forced strict tool call
with a provider-normalized schema, then applies the complete generated codec.
