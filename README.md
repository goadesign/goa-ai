...
| [Deferred tool search](docs/tool_search.md#provider-behavior) | Load definitions on demand using OpenAI native client search with BM25 or Claude hosted search. Generated `Deferred()` choices and preserved native identities support replay and history trimming. |
