...
const (
	...
	Registry_Unregister_FullMethodName     = "/registry.Registry/Unregister"
	Registry_EmitToolResult_FullMethodName = "/registry.Registry/EmitToolResult"
	Registry_Pong_FullMethodName           = "/registry.Registry/Pong"
	Registry_ListToolsets_FullMethodName   = "/registry.Registry/ListToolsets"
	Registry_GetToolset_FullMethodName     = "/registry.Registry/GetToolset"
	Registry_Search_FullMethodName         = "/registry.Registry/Search"
	Registry_CallTool_FullMethodName       = "/registry.Registry/CallTool"
)
...
type RegistryClient interface {
	...
	EmitToolResult(ctx context.Context, in *EmitToolResultRequest, opts ...grpc.CallOption) (*EmitToolResultResponse, error)
...
func (c *registryClient) EmitToolResult(ctx context.Context, in *EmitToolResultRequest, opts ...grpc.CallOption) (*EmitToolResultResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(EmitToolResultResponse)
	err := c.cc.Invoke(ctx, Registry_EmitToolResult_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RegistryServer interface {
	...
	// Emit a tool execution result to the result stream
	EmitToolResult(context.Context, *EmitToolResultRequest) (*EmitToolResultResponse, error)
	// Respond to a health check ping
...
func (UnimplementedRegistryServer) EmitToolResult(context.Context, *EmitToolResultRequest) (*EmitToolResultResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method EmitToolResult not implemented")
}
...
func _Registry_EmitToolResult_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EmitToolResultRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RegistryServer).EmitToolResult(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Registry_EmitToolResult_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RegistryServer).EmitToolResult(ctx, req.(*EmitToolResultRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Registry_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "EmitToolResult",
			Handler:    _Registry_EmitToolResult_Handler,
		},
		{
			MethodName: "Pong",
