...
func NewEndpoints(s Service) *Endpoints {
	return &Endpoints{
		...
		EmitToolResult: NewEmitToolResultEndpoint(s),
...
func (e *Endpoints) Use(m func(goa.Endpoint) goa.Endpoint) {
	...
	e.EmitToolResult = m(e.EmitToolResult)
	e.Pong = m(e.Pong)
...
// NewEmitToolResultEndpoint returns an endpoint function that calls the method
// "EmitToolResult" of service "registry".
func NewEmitToolResultEndpoint(s Service) goa.Endpoint {
	return func(ctx context.Context, req any) (any, error) {
		p := req.(*EmitToolResultPayload)
		return nil, s.EmitToolResult(ctx, p)
	}
}
