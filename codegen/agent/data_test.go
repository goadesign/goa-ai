...
func TestBuildGeneratorData(t *testing.T) {
	...
	require.Equal(t, 1, agent.Runtime.Activities[0].RetryPolicy.MaxAttempts)
	require.Zero(t, agent.Runtime.Activities[0].RetryPolicy.InitialInterval)
	require.Zero(t, agent.Runtime.Activities[0].RetryPolicy.BackoffCoefficient)
	...
	require.Equal(t, 1, agent.Runtime.Activities[1].RetryPolicy.MaxAttempts)
	require.Zero(t, agent.Runtime.Activities[1].RetryPolicy.InitialInterval)
	require.Zero(t, agent.Runtime.Activities[1].RetryPolicy.BackoffCoefficient)
