...
type (
	...
	ToolData struct {
		...
		// binds to a method named "search_records", MethodGoName will be "SearchRecords",
		...
		// as generated by Goa (e.g., CatalogSearchRecordsPayload). Empty when not bound.
		MethodPayloadTypeName string
		// MethodResultTypeName is the exact result type name for the bound method
		// as generated by Goa (e.g., CatalogSearchRecordsResult). Empty when not bound.
	...
	//
	// RetryPolicy and timeout fields control resilience: Plan/Resume activities
	// make one attempt because they may stream model text, while ExecuteTool uses
	// stable tool-call identity and may retry. Queue overrides the default activity
