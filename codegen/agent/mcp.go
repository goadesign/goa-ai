...
// populateMCPToolset returns true when an MCP suite defined in the Goa design
// was found and used to populate tools. When false is returned, callers may
// choose to populate tools from inline tool declarations (custom external MCP).
