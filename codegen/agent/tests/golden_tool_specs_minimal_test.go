...
func TestGolden_ToolSpecs_Minimal(t *testing.T) {
	...
	require.Contains(t, specs, "func SchemaFingerprint(toolset string) (string, error)")
	require.Contains(t, specs, "func RegistrationToken(toolset, admissionRevision string) (string, error)")
