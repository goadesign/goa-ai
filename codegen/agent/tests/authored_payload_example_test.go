...
func TestAuthoredPayloadExamplePreservedInToolSpecs(t *testing.T) {
	...
	require.Contains(t, specsSrc, `\"example\":{\"limit\":7,\"query\":\"recent records\"}`)
	...
	require.Contains(t, specsSrc, `ExampleJSON:tools.RawJSON("{\"limit\":7,\"query\":\"recent records\"}")`)
...
func TestAuthoredPayloadExamplePreservedThroughPrepareInToolSpecs(t *testing.T) {
	...
	require.Contains(t, specsSrc, `\"example\":{\"query\":{\"type\":\"by_name\",\"value\":{\"name\":\"record_1\"}}}`)
	require.Contains(t, specsSrc, `ExampleJSON:tools.RawJSON("{\"query\":{\"type\":\"by_name\",\"value\":{\"name\":\"record_1\"}}}")`)
