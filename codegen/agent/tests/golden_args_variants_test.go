...
func TestGolden_Args_UnionSumTypes(t *testing.T) {
	...
	transportTypes := renderedFileContent(t, files, "gen/alpha/toolsets/union/http/types.go")
	transportValidation := renderedFileContent(t, files, "gen/alpha/toolsets/union/http/validate.go")
	...
	assertGoldenGo(t, "args_union_sum_types", "transport_types.go.golden", transportTypes)
	assertGoldenGo(t, "args_union_sum_types", "transport_validate.go.golden", transportValidation)
