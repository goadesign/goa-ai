...
func initializeSession(
    ...
    {{- end }}
    session.Begin()
    initialized := &{{ .InitializedPayloadType }}{}
    req, err := client.{{ .InitializedRequestBuilder }}(ctx, initialized)
    if err != nil {
        return err
    }
    if err := {{ .InitializedRequestEncoder }}(client.encoder)(req, initialized); err != nil {
        return err
    }
