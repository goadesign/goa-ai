...
func UnmarshalAnswerPayload(data []byte) (*AnswerPayload, error) {
	...
	if err := decodeKnownJSON(
		data,
		&tv,
		answerPayloadFieldAllowedObjectKeys, answerPayloadFieldJSONTypes, answerPayloadFieldDescs,
	); err != nil {
...
func UnmarshalAnswerResult(data []byte) (*AnswerResult, error) {
	...
	if err := decodeKnownJSON(
		data,
		&tv,
		answerResultFieldAllowedObjectKeys, answerResultFieldJSONTypes, answerResultFieldDescs,
	); err != nil {
