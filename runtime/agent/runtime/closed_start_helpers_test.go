...
// runtime. Session children have a real parent in their Session.
func newClosedStartFixture(t *testing.T, kind storageCommandKind, status session.RunStatus) closedStartFixture {
	t.Helper()
