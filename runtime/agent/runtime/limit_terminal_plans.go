...
// validateLimitTerminalCall checks that the executing agent owns the named
// terminal bookkeeping tool and that its generated codec accepts the payload.
...
// cloneLimitTerminalCall copies one terminal call and its JSON payload.
