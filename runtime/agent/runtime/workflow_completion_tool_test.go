...
// These tests verify that a required completion tool ends a run only after its
// side effect succeeds. Planner text and finalization turns cannot substitute
// for the required tool result.
