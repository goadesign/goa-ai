...
const example_analyze_sentiment = `{"text":"I love this new feature! It works perfectly."}`
const example_extract_keywords = `{"text":"Machine learning algorithms process data to identify patterns."}`
const example_summarize_text = `{"text":"This is a long text that needs to be summarized."}`
