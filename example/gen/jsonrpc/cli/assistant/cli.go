...
func UsageCommands() []string {
	return []string{
		"assistant (analyze-sentiment|extract-keywords|summarize-text|search-knowledge|execute-code|list-documents|get-system-info|get-conversation-history|generate-prompts|send-notification|subscribe-to-updates|process-batch)",
	}
}

// UsageExamples produces an example of a valid invocation of the CLI tool.
func UsageExamples() string {
	return os.Args[0] + " " + "assistant analyze-sentiment --body '{\n      \"text\": \"I love this new feature! It works perfectly.\"\n   }'" + "\n" +
		""
}
...
func assistantUsage() {
	...
	fmt.Fprintln(os.Stderr, `    analyze-sentiment: Analyze text sentiment`)
...
func assistantAnalyzeSentimentUsage() {
	...
	// Description
	fmt.Fprintln(os.Stderr)
	fmt.Fprintln(os.Stderr, `Analyze text sentiment`)
