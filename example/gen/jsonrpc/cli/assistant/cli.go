	...
	)
	{
		...
		case "assistant":
			...
			case "monitor-resource-changes":
				...
				data, err = assistantc.BuildMonitorResourceChangesPayload(*assistantMonitorResourceChangesBodyFlag)
			case "stream-logs":
...
func assistantMonitorResourceChangesUsage() {
	fmt.Fprintf(os.Stderr, `%[1]s [flags] assistant monitor-resource-changes -body JSON
