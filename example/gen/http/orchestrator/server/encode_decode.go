...
//
// orchestrator HTTP server encoders and decoders
//
// Command:
...
// endpoint.
func DecodeRunRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*orchestrator.AgentRunPayload, error) {
	return func(r *http.Request) (*orchestrator.AgentRunPayload, error) {
		var (
			body RunRequestBody
			err  error
		)
