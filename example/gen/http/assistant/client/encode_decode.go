...
func DecodeSearchKnowledgeResponse(decoder func(*http.Response) goahttp.Decoder, restoreBody bool) func(*http.Response) (any, error) {
	return func(resp *http.Response) (any, error) {
		...
		case http.StatusOK:
			...
			res := NewSearchKnowledgeSearchResultOK(body)
			return res, nil
		default:
			body, _ := io.ReadAll(resp.Body)
...
func DecodeListDocumentsResponse(decoder func(*http.Response) goahttp.Decoder, restoreBody bool) func(*http.Response) (any, error) {
	return func(resp *http.Response) (any, error) {
		...
		case http.StatusOK:
			...
			res := NewListDocumentsDocumentOK(body)
			return res, nil
		default:
			body, _ := io.ReadAll(resp.Body)
...
func DecodeGetConversationHistoryResponse(decoder func(*http.Response) goahttp.Decoder, restoreBody bool) func(*http.Response) (any, error) {
	return func(resp *http.Response) (any, error) {
		...
		case http.StatusOK:
			...
			res := NewGetConversationHistoryChatMessageOK(body)
			return res, nil
		default:
			body, _ := io.ReadAll(resp.Body)
...
func DecodeGeneratePromptsResponse(decoder func(*http.Response) goahttp.Decoder, restoreBody bool) func(*http.Response) (any, error) {
	return func(resp *http.Response) (any, error) {
		...
		case http.StatusOK:
			...
			res := NewGeneratePromptsPromptTemplateOK(body)
			return res, nil
		default:
			body, _ := io.ReadAll(resp.Body)
...
// BuildRequestCompletionRequest instantiates a HTTP request object with method
// and path set to call the "assistant" service "request_completion" endpoint
func (c *Client) BuildRequestCompletionRequest(ctx context.Context, v any) (*http.Request, error) {
	u := &url.URL{Scheme: c.scheme, Host: c.host, Path: RequestCompletionAssistantPath()}
	req, err := http.NewRequest("POST", u.String(), nil)
	if err != nil {
		return nil, goahttp.ErrInvalidURL("assistant", "request_completion", u.String(), err)
	}
	if ctx != nil {
		req = req.WithContext(ctx)
	}
...
// EncodeRequestCompletionRequest returns an encoder for requests sent to the
// assistant request_completion server.
func EncodeRequestCompletionRequest(encoder func(*http.Request) goahttp.Encoder) func(*http.Request, any) error {
	return func(req *http.Request, v any) error {
		p, ok := v.(*assistant.RequestCompletionPayload)
		if !ok {
			return goahttp.ErrInvalidType("assistant", "request_completion", "*assistant.RequestCompletionPayload", v)
		}
		body := NewRequestCompletionRequestBody(p)
		if err := encoder(req).Encode(&body); err != nil {
			return goahttp.ErrEncodingError("assistant", "request_completion", err)
		}
		return nil
	}
}

// DecodeRequestCompletionResponse returns a decoder for responses returned by
// the assistant request_completion endpoint. restoreBody controls whether the
// response body should be restored after having been read.
func DecodeRequestCompletionResponse(decoder func(*http.Response) goahttp.Decoder, restoreBody bool) func(*http.Response) (any, error) {
	return func(resp *http.Response) (any, error) {
		if restoreBody {
			b, err := io.ReadAll(resp.Body)
			if err != nil {
		...
		case http.StatusOK:
			...
			err = decoder(resp).Decode(&body)
			if err != nil {
				return nil, goahttp.ErrDecodingError("assistant", "request_completion", err)
			}
			err = ValidateRequestCompletionResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("assistant", "request_completion", err)
			}
			res := NewRequestCompletionResultOK(&body)
			return res, nil
		default:
			body, _ := io.ReadAll(resp.Body)
			return nil, goahttp.ErrInvalidResponse("assistant", "request_completion", resp.StatusCode, string(body))
		}
	}
}
...
func (c *Client) BuildMonitorResourceChangesRequest(ctx context.Context, v any) (*http.Request, error) {
	...
	{
		p, ok := v.(*assistant.MonitorResourceChangesPayload)
		if !ok {
			return nil, goahttp.ErrInvalidType("assistant", "monitor_resource_changes", "*assistant.MonitorResourceChangesPayload", v)
		}
		subscriptionID = p.SubscriptionID
	}
	u := &url.URL{Scheme: c.scheme, Host: c.host, Path: MonitorResourceChangesAssistantPath(subscriptionID)}
	req, err := http.NewRequest("GET", u.String(), nil)
	if err != nil {
		return nil, goahttp.ErrInvalidURL("assistant", "monitor_resource_changes", u.String(), err)
	}
	if ctx != nil {
		req = req.WithContext(ctx)
	}
...
// the assistant monitor_resource_changes server.
func EncodeMonitorResourceChangesRequest(encoder func(*http.Request) goahttp.Encoder) func(*http.Request, any) error {
	return func(req *http.Request, v any) error {
		p, ok := v.(*assistant.MonitorResourceChangesPayload)
		if !ok {
			return goahttp.ErrInvalidType("assistant", "monitor_resource_changes", "*assistant.MonitorResourceChangesPayload", v)
		}
		body := NewMonitorResourceChangesRequestBody(p)
		if err := encoder(req).Encode(&body); err != nil {
			return goahttp.ErrEncodingError("assistant", "monitor_resource_changes", err)
		}
		return nil
	}
}
...
// returned by the assistant monitor_resource_changes endpoint. restoreBody
// controls whether the response body should be restored after having been read.
func DecodeMonitorResourceChangesResponse(decoder func(*http.Response) goahttp.Decoder, restoreBody bool) func(*http.Response) (any, error) {
	return func(resp *http.Response) (any, error) {
		...
		case http.StatusOK:
			...
			err = decoder(resp).Decode(&body)
			if err != nil {
				return nil, goahttp.ErrDecodingError("assistant", "monitor_resource_changes", err)
			}
			err = ValidateMonitorResourceChangesResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("assistant", "monitor_resource_changes", err)
			}
			res := NewMonitorResourceChangesResultOK(&body)
			return res, nil
		default:
			body, _ := io.ReadAll(resp.Body)
			return nil, goahttp.ErrInvalidResponse("assistant", "monitor_resource_changes", resp.StatusCode, string(body))
		}
	}
}

// BuildStreamLogsRequest instantiates a HTTP request object with method and
// path set to call the "assistant" service "stream_logs" endpoint
func (c *Client) BuildStreamLogsRequest(ctx context.Context, v any) (*http.Request, error) {
	u := &url.URL{Scheme: c.scheme, Host: c.host, Path: StreamLogsAssistantPath()}
	req, err := http.NewRequest("GET", u.String(), nil)
	if err != nil {
		return nil, goahttp.ErrInvalidURL("assistant", "stream_logs", u.String(), err)
	}
	if ctx != nil {
		req = req.WithContext(ctx)
	}
...
// assistant stream_logs server.
func EncodeStreamLogsRequest(encoder func(*http.Request) goahttp.Encoder) func(*http.Request, any) error {
	return func(req *http.Request, v any) error {
		p, ok := v.(*assistant.StreamLogsPayload)
		if !ok {
			return goahttp.ErrInvalidType("assistant", "stream_logs", "*assistant.StreamLogsPayload", v)
		}
		body := NewStreamLogsRequestBody(p)
		if err := encoder(req).Encode(&body); err != nil {
			return goahttp.ErrEncodingError("assistant", "stream_logs", err)
		}
		return nil
	}
}
...
// assistant stream_logs endpoint. restoreBody controls whether the response
// body should be restored after having been read.
func DecodeStreamLogsResponse(decoder func(*http.Response) goahttp.Decoder, restoreBody bool) func(*http.Response) (any, error) {
	return func(resp *http.Response) (any, error) {
		...
		case http.StatusOK:
			...
			err = decoder(resp).Decode(&body)
			if err != nil {
				return nil, goahttp.ErrDecodingError("assistant", "stream_logs", err)
			}
			err = ValidateStreamLogsResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("assistant", "stream_logs", err)
			}
			res := NewStreamLogsResultOK(&body)
			return res, nil
		default:
			body, _ := io.ReadAll(resp.Body)
			return nil, goahttp.ErrInvalidResponse("assistant", "stream_logs", resp.StatusCode, string(body))
		}
	}
}
...
// marshalAssistantSamplingMessageToSamplingMessageRequestBody builds a value
// of type *SamplingMessageRequestBody from a value of type
// *assistant.SamplingMessage.
func marshalAssistantSamplingMessageToSamplingMessageRequestBody(v *assistant.SamplingMessage) *SamplingMessageRequestBody {
	res := &SamplingMessageRequestBody{
		Role:    v.Role,
		Content: v.Content,
	}
...
// marshalAssistantModelHintToModelHintRequestBody builds a value of type
// *ModelHintRequestBody from a value of type *assistant.ModelHint.
func marshalAssistantModelHintToModelHintRequestBody(v *assistant.ModelHint) *ModelHintRequestBody {
	if v == nil {
		return nil
	}
	res := &ModelHintRequestBody{
		Name: v.Name,
	}
...
// marshalSamplingMessageRequestBodyToAssistantSamplingMessage builds a value
// of type *assistant.SamplingMessage from a value of type
// *SamplingMessageRequestBody.
func marshalSamplingMessageRequestBodyToAssistantSamplingMessage(v *SamplingMessageRequestBody) *assistant.SamplingMessage {
...
// marshalModelHintRequestBodyToAssistantModelHint builds a value of type
// *assistant.ModelHint from a value of type *ModelHintRequestBody.
func marshalModelHintRequestBodyToAssistantModelHint(v *ModelHintRequestBody) *assistant.ModelHint {
	if v == nil {
		return nil
	}
...
// unmarshalResourceUpdateResponseBodyToAssistantResourceUpdate builds a value
// of type *assistant.ResourceUpdate from a value of type
// *ResourceUpdateResponseBody.
func unmarshalResourceUpdateResponseBodyToAssistantResourceUpdate(v *ResourceUpdateResponseBody) *assistant.ResourceUpdate {
	res := &assistant.ResourceUpdate{
		UpdateID:  *v.UpdateID,
		Resource:  *v.Resource,
...
// unmarshalLogEntryResponseBodyToAssistantLogEntry builds a value of type
// *assistant.LogEntry from a value of type *LogEntryResponseBody.
func unmarshalLogEntryResponseBodyToAssistantLogEntry(v *LogEntryResponseBody) *assistant.LogEntry {
	res := &assistant.LogEntry{
		Timestamp: *v.Timestamp,
		Level:     *v.Level,
		Message:   *v.Message,
	}
