...
func BuildMonitorResourceChangesPayload(assistantMonitorResourceChangesBody string, assistantMonitorResourceChangesSubscriptionID string) (*assistant.MonitorResourceChangesPayload, error) {
	var err error
	...
	{
		subscriptionID = assistantMonitorResourceChangesSubscriptionID
	}
