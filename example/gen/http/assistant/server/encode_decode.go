...
func DecodeRequestCompletionRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*assistant.RequestCompletionPayload, error) {
	return func(r *http.Request) (*assistant.RequestCompletionPayload, error) {
		var (
...
func DecodeMonitorResourceChangesRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*assistant.MonitorResourceChangesPayload, error) {
	return func(r *http.Request) (*assistant.MonitorResourceChangesPayload, error) {
		var (
		...
		payload := NewMonitorResourceChangesPayload(&body, subscriptionID)
...
func DecodeStreamLogsRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*assistant.StreamLogsPayload, error) {
	return func(r *http.Request) (*assistant.StreamLogsPayload, error) {
		var (
