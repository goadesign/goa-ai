...
func NewEndpoints(
	...
	e.AnalyzeSentiment = func(ctx context.Context, v any) (any, error) {
		...
		if err != nil {
			prompt := retry.BuildRepairPrompt("tools/call:analyze_sentiment", err.Error(), "{\"text\":\"I love this new feature! It works perfectly.\"}", "{\"additionalProperties\":false,\"properties\":{\"text\":{\"maxLength\":10000,\"minLength\":1,\"type\":\"string\"}},\"required\":[\"text\"],\"type\":\"object\"}")
		...
		for {
			...
			if recvErr != nil {
				prompt := retry.BuildRepairPrompt("tools/call:analyze_sentiment", recvErr.Error(), "{\"text\":\"I love this new feature! It works perfectly.\"}", "{\"additionalProperties\":false,\"properties\":{\"text\":{\"maxLength\":10000,\"minLength\":1,\"type\":\"string\"}},\"required\":[\"text\"],\"type\":\"object\"}")
		...
		if r == nil || r.Content == nil || len(r.Content) == 0 || r.Content[0] == nil || r.Content[0].Text == nil {
			prompt := retry.BuildRepairPrompt("tools/call:analyze_sentiment", "empty MCP tool response", "{\"text\":\"I love this new feature! It works perfectly.\"}", "{\"additionalProperties\":false,\"properties\":{\"text\":{\"maxLength\":10000,\"minLength\":1,\"type\":\"string\"}},\"required\":[\"text\"],\"type\":\"object\"}")
	...
	e.ExtractKeywords = func(ctx context.Context, v any) (any, error) {
		...
		if err != nil {
			prompt := retry.BuildRepairPrompt("tools/call:extract_keywords", err.Error(), "{\"text\":\"Machine learning algorithms process data to identify patterns.\"}", "{\"additionalProperties\":false,\"properties\":{\"text\":{\"maxLength\":10000,\"minLength\":1,\"type\":\"string\"}},\"required\":[\"text\"],\"type\":\"object\"}")
			return nil, &retry.RetryableError{Prompt: prompt, Cause: err}
		}
		stream, ok := streamAny.(*mcpAssistantjsonrpcc.ToolsCallClientStream)
		if !ok {
		...
		for {
			...
			if recvErr != nil {
				prompt := retry.BuildRepairPrompt("tools/call:extract_keywords", recvErr.Error(), "{\"text\":\"Machine learning algorithms process data to identify patterns.\"}", "{\"additionalProperties\":false,\"properties\":{\"text\":{\"maxLength\":10000,\"minLength\":1,\"type\":\"string\"}},\"required\":[\"text\"],\"type\":\"object\"}")
				return nil, &retry.RetryableError{Prompt: prompt, Cause: recvErr}
			}
			r = ev
		}
		if r == nil || r.Content == nil || len(r.Content) == 0 || r.Content[0] == nil || r.Content[0].Text == nil {
			prompt := retry.BuildRepairPrompt("tools/call:extract_keywords", "empty MCP tool response", "{\"text\":\"Machine learning algorithms process data to identify patterns.\"}", "{\"additionalProperties\":false,\"properties\":{\"text\":{\"maxLength\":10000,\"minLength\":1,\"type\":\"string\"}},\"required\":[\"text\"],\"type\":\"object\"}")
	...
	e.SummarizeText = func(ctx context.Context, v any) (any, error) {
		...
		if err != nil {
			prompt := retry.BuildRepairPrompt("tools/call:summarize_text", err.Error(), "{\"text\":\"This is a long text that needs to be summarized.\"}", "{\"additionalProperties\":false,\"properties\":{\"text\":{\"maxLength\":10000,\"minLength\":1,\"type\":\"string\"}},\"required\":[\"text\"],\"type\":\"object\"}")
			return nil, &retry.RetryableError{Prompt: prompt, Cause: err}
		}
		stream, ok := streamAny.(*mcpAssistantjsonrpcc.ToolsCallClientStream)
		if !ok {
		...
		for {
			...
			if recvErr != nil {
				prompt := retry.BuildRepairPrompt("tools/call:summarize_text", recvErr.Error(), "{\"text\":\"This is a long text that needs to be summarized.\"}", "{\"additionalProperties\":false,\"properties\":{\"text\":{\"maxLength\":10000,\"minLength\":1,\"type\":\"string\"}},\"required\":[\"text\"],\"type\":\"object\"}")
				return nil, &retry.RetryableError{Prompt: prompt, Cause: recvErr}
			}
			r = ev
		}
		if r == nil || r.Content == nil || len(r.Content) == 0 || r.Content[0] == nil || r.Content[0].Text == nil {
			prompt := retry.BuildRepairPrompt("tools/call:summarize_text", "empty MCP tool response", "{\"text\":\"This is a long text that needs to be summarized.\"}", "{\"additionalProperties\":false,\"properties\":{\"text\":{\"maxLength\":10000,\"minLength\":1,\"type\":\"string\"}},\"required\":[\"text\"],\"type\":\"object\"}")
