...
type Service interface {
	...
	AnalyzeSentiment(context.Context, *AnalyzeSentimentPayload) (res *SentimentResult, err error)
	// Extract keywords from text
	ExtractKeywords(context.Context, *ExtractKeywordsPayload) (res *KeywordsResult, err error)
	// Summarize text
	SummarizeText(context.Context, *SummarizeTextPayload) (res *SummaryResult, err error)
...
// MethodKey key.
var MethodNames = [12]string{"analyze_sentiment", "extract_keywords", "summarize_text", "search_knowledge", "execute_code", "list_documents", "get_system_info", "get_conversation_history", "generate_prompts", "send_notification", "subscribe_to_updates", "process_batch"}
...
type ProcessBatchClientStream interface {
	...
	// RecvWithContext reads instances of "BatchResult" from the stream with
	// context.
...
type Stream interface {
	...
	// Accepted types: *SentimentResult, *KeywordsResult, *SummaryResult,
	// SearchResults, *ExecutionResult, Documents, *SystemInfo,
	// *ConversationHistory, PromptTemplates, *SubscriptionInfo, *BatchResult
...
func (*SentimentResult) isassistantEvent() {}

// isassistantEvent implements the Event interface.
func (*KeywordsResult) isassistantEvent() {}

// isassistantEvent implements the Event interface.
func (*SummaryResult) isassistantEvent() {}
...
// KeywordsResult is the result type of the assistant service extract_keywords
// method.
...
// SentimentResult is the result type of the assistant service
// analyze_sentiment method.
...
// SummaryResult is the result type of the assistant service summarize_text
// method.
