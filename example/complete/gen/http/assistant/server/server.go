...
type Server struct {
	...
	RequestCompletion      http.Handler
...
func New(
	...
	return &Server{
		Mounts: []*MountPoint{
			...
			{"RequestCompletion", "POST", "/api/complete"},
			...
			{"MonitorResourceChanges", "GET", "/api/monitor/{subscription_id}"},
			{"StreamLogs", "GET", "/api/logs"},
		},
		...
		RequestCompletion:      NewRequestCompletionHandler(e.RequestCompletion, mux, decoder, encoder, errhandler, formatter),
		...
		MonitorResourceChanges: NewMonitorResourceChangesHandler(e.MonitorResourceChanges, mux, decoder, encoder, errhandler, formatter),
		StreamLogs:             NewStreamLogsHandler(e.StreamLogs, mux, decoder, encoder, errhandler, formatter),
	}
}
...
func (s *Server) Use(m func(http.Handler) http.Handler) {
	...
	s.RequestCompletion = m(s.RequestCompletion)
...
func Mount(mux goahttp.Muxer, h *Server) {
	...
	MountRequestCompletionHandler(mux, h.RequestCompletion)
...
// MountRequestCompletionHandler configures the mux to serve the "assistant"
// service "request_completion" endpoint.
func MountRequestCompletionHandler(mux goahttp.Muxer, h http.Handler) {
	f, ok := h.(http.HandlerFunc)
	if !ok {
		f = func(w http.ResponseWriter, r *http.Request) {
			h.ServeHTTP(w, r)
	...
	mux.Handle("POST", "/api/complete", f)
}

// NewRequestCompletionHandler creates a HTTP handler which loads the HTTP
// request and calls the "assistant" service "request_completion" endpoint.
func NewRequestCompletionHandler(
	...
	var (
		decodeRequest  = DecodeRequestCompletionRequest(mux, decoder)
		encodeResponse = EncodeRequestCompletionResponse(encoder)
		encodeError    = goahttp.ErrorEncoder(encoder, formatter)
	)
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		ctx := context.WithValue(r.Context(), goahttp.AcceptTypeKey, r.Header.Get("Accept"))
...
func MountMonitorResourceChangesHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("GET", "/api/monitor/{subscription_id}", f)
}

// NewMonitorResourceChangesHandler creates a HTTP handler which loads the HTTP
// request and calls the "assistant" service "monitor_resource_changes"
// endpoint.
func NewMonitorResourceChangesHandler(
	...
	var (
		...
		encodeResponse = EncodeMonitorResourceChangesResponse(encoder)
		encodeError    = goahttp.ErrorEncoder(encoder, formatter)
	)
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		ctx := context.WithValue(r.Context(), goahttp.AcceptTypeKey, r.Header.Get("Accept"))
...
// MountStreamLogsHandler configures the mux to serve the "assistant" service
...
func NewStreamLogsHandler(
	...
	var (
		...
		encodeResponse = EncodeStreamLogsResponse(encoder)
		encodeError    = goahttp.ErrorEncoder(encoder, formatter)
	)
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		ctx := context.WithValue(r.Context(), goahttp.AcceptTypeKey, r.Header.Get("Accept"))
