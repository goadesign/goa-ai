...
type InitializeRequestBody struct {
	...
	// Client information
	ClientInfo *ClientInfoRequestBodyRequestBody `form:"clientInfo,omitempty" json:"clientInfo,omitempty" xml:"clientInfo,omitempty"`
}
...
func NewInitializePayload(body *InitializeRequestBody) *mcpassistant.InitializePayload {
	...
	v.ClientInfo = unmarshalClientInfoRequestBodyRequestBodyToMcpassistantClientInfo(body.ClientInfo)
...
func NewNotifyStatusUpdatePayload(body *NotifyStatusUpdateRequestBody) *mcpassistant.NotifyStatusUpdatePayload {
...
// payload.
func NewSubscribePayload(body *SubscribeRequestBody) *mcpassistant.SubscribePayload {
...
// payload.
func NewUnsubscribePayload(body *UnsubscribeRequestBody) *mcpassistant.UnsubscribePayload {
...
func ValidateInitializeRequestBody(body *InitializeRequestBody) (err error) {
	...
	if body.ClientInfo != nil {
		if err2 := ValidateClientInfoRequestBodyRequestBody(body.ClientInfo); err2 != nil {
...
// ValidateSubscribeRequestBody runs the validations defined on
// SubscribeRequestBody
func ValidateSubscribeRequestBody(body *SubscribeRequestBody) (err error) {
	if body.URI == nil {
		err = goa.MergeErrors(err, goa.MissingFieldError("uri", "body"))
	}
	return
...
// ValidateUnsubscribeRequestBody runs the validations defined on
// UnsubscribeRequestBody
func ValidateUnsubscribeRequestBody(body *UnsubscribeRequestBody) (err error) {
	if body.URI == nil {
		err = goa.MergeErrors(err, goa.MissingFieldError("uri", "body"))
	}
	return
...
// ValidateClientInfoRequestBodyRequestBody runs the validations defined on
// ClientInfoRequestBodyRequestBody
func ValidateClientInfoRequestBodyRequestBody(body *ClientInfoRequestBodyRequestBody) (err error) {
	if body.Name == nil {
		err = goa.MergeErrors(err, goa.MissingFieldError("name", "body"))
	}
	if body.Version == nil {
