...
type InitializeRequestBody struct {
	...
	// Client information
	ClientInfo *ClientInfoRequestBodyRequestBody `form:"clientInfo" json:"clientInfo" xml:"clientInfo"`
}
...
// SubscribeRequestBody is the type of the "mcp_assistant" service "subscribe"
// endpoint HTTP request body.
...
// UnsubscribeRequestBody is the type of the "mcp_assistant" service
// "unsubscribe" endpoint HTTP request body.
...
// ClientInfoRequestBodyRequestBody is used to define fields on request body
// types.
type ClientInfoRequestBodyRequestBody struct {
	// Client name
	Name string `form:"name" json:"name" xml:"name"`
	// Client version
...
func NewInitializeRequestBody(p *mcpassistant.InitializePayload) *InitializeRequestBody {
	...
	if p.ClientInfo != nil {
		body.ClientInfo = marshalMcpassistantClientInfoToClientInfoRequestBodyRequestBody(p.ClientInfo)
	}
	return body
}
...
// service.
func NewNotifyStatusUpdateRequestBody(p *mcpassistant.NotifyStatusUpdatePayload) *NotifyStatusUpdateRequestBody {
...
// NewSubscribeRequestBody builds the HTTP request body from the payload of the
// "subscribe" endpoint of the "mcp_assistant" service.
func NewSubscribeRequestBody(p *mcpassistant.SubscribePayload) *SubscribeRequestBody {
...
// NewUnsubscribeRequestBody builds the HTTP request body from the payload of
// the "unsubscribe" endpoint of the "mcp_assistant" service.
func NewUnsubscribeRequestBody(p *mcpassistant.UnsubscribePayload) *UnsubscribeRequestBody {
