...
func NewMonitorResourceChangesPayload(body *MonitorResourceChangesRequestBody) *assistant.MonitorResourceChangesPayload {
...
// ValidateMonitorResourceChangesRequestBody runs the validations defined on
// monitor_resource_changes_request_body
func ValidateMonitorResourceChangesRequestBody(body *MonitorResourceChangesRequestBody) (err error) {
