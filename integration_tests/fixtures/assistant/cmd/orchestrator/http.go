...
func handleHTTPServer(ctx context.Context, u *url.URL, mcpAssistantEndpoints *mcpassistant.Endpoints, mcpAssistantSvc mcpassistant.Service, wg *sync.WaitGroup, errc chan error, dbg bool) {
