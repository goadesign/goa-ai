...
func initializeSession(
	...
	session.Begin()
	initialized := &mcpassistant.InitializedPayload{}
	req, err := client.BuildNotificationsInitializedRequest(ctx, initialized)
	if err != nil {
		return err
	}
	if err := EncodeNotificationsInitializedRequest(client.encoder)(req, initialized); err != nil {
		return err
	}
