...
const example_analyze_sentiment = `{"text":"abc123"}`
const example_extract_keywords = `{"text":"abc123"}`
const example_summarize_text = `{"text":"abc123"}`
const example_search = `{"limit":1,"query":"abc123"}`
const example_execute_code = `{"code":"abc123","language":"javascript"}`
const example_process_batch = `{"blob":"abc123","format":"text","items":["abc123"],"mimeType":"abc123","uri":"abc123"}`

// toolExample returns a built-in example (if any) for a tool name.
func toolExample(name string) string {
	switch name {
	case "analyze_sentiment":
		return example_analyze_sentiment
	case "extract_keywords":
		return example_extract_keywords
	case "summarize_text":
		return example_summarize_text
	case "search":
