...
// DecodeNotificationsInitializedRequest returns a decoder for requests sent to
// the mcp_assistant notifications/initialized endpoint.
func DecodeNotificationsInitializedRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request, *jsonrpc.RawRequest) (*mcpassistant.InitializedPayload, error) {
	return func(r *http.Request, req *jsonrpc.RawRequest) (*mcpassistant.InitializedPayload, error) {
		r.Body = io.NopCloser(bytes.NewReader(req.Params))
		var payload *mcpassistant.InitializedPayload
		var (
		...
		payload = NewNotificationsInitializedInitializedPayload(&body)
