...
func NewEndpoints(
	...
	e.AnalyzeSentiment = func(ctx context.Context, v any) (any, error) {
		...
		if err != nil {
			prompt := retry.BuildRepairPrompt("tools/call:analyze_sentiment", err.Error(), "{\"text\":\"abc123\"}", "{\"additionalProperties\":false,\"properties\":{\"text\":{\"type\":\"string\"}},\"required\":[\"text\"],\"type\":\"object\"}")
		...
		for {
			...
			if recvErr != nil {
				prompt := retry.BuildRepairPrompt("tools/call:analyze_sentiment", recvErr.Error(), "{\"text\":\"abc123\"}", "{\"additionalProperties\":false,\"properties\":{\"text\":{\"type\":\"string\"}},\"required\":[\"text\"],\"type\":\"object\"}")
		...
		if r == nil || r.Content == nil || len(r.Content) == 0 || r.Content[0] == nil || r.Content[0].Text == nil {
			prompt := retry.BuildRepairPrompt("tools/call:analyze_sentiment", "empty MCP tool response", "{\"text\":\"abc123\"}", "{\"additionalProperties\":false,\"properties\":{\"text\":{\"type\":\"string\"}},\"required\":[\"text\"],\"type\":\"object\"}")
	...
	e.ExtractKeywords = func(ctx context.Context, v any) (any, error) {
		...
		if err != nil {
			prompt := retry.BuildRepairPrompt("tools/call:extract_keywords", err.Error(), "{\"text\":\"abc123\"}", "{\"additionalProperties\":false,\"properties\":{\"text\":{\"type\":\"string\"}},\"required\":[\"text\"],\"type\":\"object\"}")
			return nil, &retry.RetryableError{Prompt: prompt, Cause: err}
		}
		stream, ok := streamAny.(*mcpAssistantjsonrpcc.ToolsCallClientStream)
		if !ok {
		...
		for {
			...
			if recvErr != nil {
				prompt := retry.BuildRepairPrompt("tools/call:extract_keywords", recvErr.Error(), "{\"text\":\"abc123\"}", "{\"additionalProperties\":false,\"properties\":{\"text\":{\"type\":\"string\"}},\"required\":[\"text\"],\"type\":\"object\"}")
				return nil, &retry.RetryableError{Prompt: prompt, Cause: recvErr}
			}
			r = ev
		}
		if r == nil || r.Content == nil || len(r.Content) == 0 || r.Content[0] == nil || r.Content[0].Text == nil {
			prompt := retry.BuildRepairPrompt("tools/call:extract_keywords", "empty MCP tool response", "{\"text\":\"abc123\"}", "{\"additionalProperties\":false,\"properties\":{\"text\":{\"type\":\"string\"}},\"required\":[\"text\"],\"type\":\"object\"}")
	...
	e.SummarizeText = func(ctx context.Context, v any) (any, error) {
		...
		if err != nil {
			prompt := retry.BuildRepairPrompt("tools/call:summarize_text", err.Error(), "{\"text\":\"abc123\"}", "{\"additionalProperties\":false,\"properties\":{\"text\":{\"type\":\"string\"}},\"required\":[\"text\"],\"type\":\"object\"}")
			return nil, &retry.RetryableError{Prompt: prompt, Cause: err}
		}
		stream, ok := streamAny.(*mcpAssistantjsonrpcc.ToolsCallClientStream)
		if !ok {
		...
		for {
			...
			if recvErr != nil {
				prompt := retry.BuildRepairPrompt("tools/call:summarize_text", recvErr.Error(), "{\"text\":\"abc123\"}", "{\"additionalProperties\":false,\"properties\":{\"text\":{\"type\":\"string\"}},\"required\":[\"text\"],\"type\":\"object\"}")
				return nil, &retry.RetryableError{Prompt: prompt, Cause: recvErr}
			}
			r = ev
		}
		if r == nil || r.Content == nil || len(r.Content) == 0 || r.Content[0] == nil || r.Content[0].Text == nil {
			prompt := retry.BuildRepairPrompt("tools/call:summarize_text", "empty MCP tool response", "{\"text\":\"abc123\"}", "{\"additionalProperties\":false,\"properties\":{\"text\":{\"type\":\"string\"}},\"required\":[\"text\"],\"type\":\"object\"}")
	...
	e.Search = func(ctx context.Context, v any) (any, error) {
		...
		if err != nil {
			prompt := retry.BuildRepairPrompt("tools/call:search", err.Error(), "{\"limit\":1,\"query\":\"abc123\"}", "{\"additionalProperties\":false,\"properties\":{\"limit\":{\"type\":\"integer\"},\"query\":{\"type\":\"string\"}},\"required\":[\"query\"],\"type\":\"object\"}")
			return nil, &retry.RetryableError{Prompt: prompt, Cause: err}
		}
		stream, ok := streamAny.(*mcpAssistantjsonrpcc.ToolsCallClientStream)
		if !ok {
		...
		for {
			...
			if recvErr != nil {
				prompt := retry.BuildRepairPrompt("tools/call:search", recvErr.Error(), "{\"limit\":1,\"query\":\"abc123\"}", "{\"additionalProperties\":false,\"properties\":{\"limit\":{\"type\":\"integer\"},\"query\":{\"type\":\"string\"}},\"required\":[\"query\"],\"type\":\"object\"}")
				return nil, &retry.RetryableError{Prompt: prompt, Cause: recvErr}
			}
			r = ev
		}
		if r == nil || r.Content == nil || len(r.Content) == 0 || r.Content[0] == nil || r.Content[0].Text == nil {
			prompt := retry.BuildRepairPrompt("tools/call:search", "empty MCP tool response", "{\"limit\":1,\"query\":\"abc123\"}", "{\"additionalProperties\":false,\"properties\":{\"limit\":{\"type\":\"integer\"},\"query\":{\"type\":\"string\"}},\"required\":[\"query\"],\"type\":\"object\"}")
	...
	e.ExecuteCode = func(ctx context.Context, v any) (any, error) {
		...
		if err != nil {
			prompt := retry.BuildRepairPrompt("tools/call:execute_code", err.Error(), "{\"code\":\"abc123\",\"language\":\"javascript\"}", "{\"additionalProperties\":false,\"properties\":{\"code\":{\"type\":\"string\"},\"language\":{\"enum\":[\"python\",\"javascript\"],\"type\":\"string\"}},\"required\":[\"language\",\"code\"],\"type\":\"object\"}")
			return nil, &retry.RetryableError{Prompt: prompt, Cause: err}
		}
		stream, ok := streamAny.(*mcpAssistantjsonrpcc.ToolsCallClientStream)
		if !ok {
		...
		for {
			...
			if recvErr != nil {
				prompt := retry.BuildRepairPrompt("tools/call:execute_code", recvErr.Error(), "{\"code\":\"abc123\",\"language\":\"javascript\"}", "{\"additionalProperties\":false,\"properties\":{\"code\":{\"type\":\"string\"},\"language\":{\"enum\":[\"python\",\"javascript\"],\"type\":\"string\"}},\"required\":[\"language\",\"code\"],\"type\":\"object\"}")
				return nil, &retry.RetryableError{Prompt: prompt, Cause: recvErr}
			}
			r = ev
		}
		if r == nil || r.Content == nil || len(r.Content) == 0 || r.Content[0] == nil || r.Content[0].Text == nil {
			prompt := retry.BuildRepairPrompt("tools/call:execute_code", "empty MCP tool response", "{\"code\":\"abc123\",\"language\":\"javascript\"}", "{\"additionalProperties\":false,\"properties\":{\"code\":{\"type\":\"string\"},\"language\":{\"enum\":[\"python\",\"javascript\"],\"type\":\"string\"}},\"required\":[\"language\",\"code\"],\"type\":\"object\"}")
	...
	e.ProcessBatch = func(ctx context.Context, v any) (any, error) {
		...
		if err != nil {
			prompt := retry.BuildRepairPrompt("tools/call:process_batch", err.Error(), "{\"blob\":\"abc123\",\"format\":\"text\",\"items\":[\"abc123\"],\"mimeType\":\"abc123\",\"uri\":\"abc123\"}", "{\"additionalProperties\":false,\"properties\":{\"blob\":{\"type\":\"string\"},\"format\":{\"enum\":[\"json\",\"text\",\"blob\",\"uri\"],\"type\":\"string\"},\"items\":{\"items\":{\"type\":\"string\"},\"type\":\"array\"},\"mimeType\":{\"type\":\"string\"},\"uri\":{\"type\":\"string\"}},\"required\":[\"items\"],\"type\":\"object\"}")
			return nil, &retry.RetryableError{Prompt: prompt, Cause: err}
		}
		stream, ok := streamAny.(*mcpAssistantjsonrpcc.ToolsCallClientStream)
		if !ok {
		...
		for {
			...
			if recvErr != nil {
				prompt := retry.BuildRepairPrompt("tools/call:process_batch", recvErr.Error(), "{\"blob\":\"abc123\",\"format\":\"text\",\"items\":[\"abc123\"],\"mimeType\":\"abc123\",\"uri\":\"abc123\"}", "{\"additionalProperties\":false,\"properties\":{\"blob\":{\"type\":\"string\"},\"format\":{\"enum\":[\"json\",\"text\",\"blob\",\"uri\"],\"type\":\"string\"},\"items\":{\"items\":{\"type\":\"string\"},\"type\":\"array\"},\"mimeType\":{\"type\":\"string\"},\"uri\":{\"type\":\"string\"}},\"required\":[\"items\"],\"type\":\"object\"}")
				return nil, &retry.RetryableError{Prompt: prompt, Cause: recvErr}
			}
			r = ev
		}
		if r == nil || r.Content == nil || len(r.Content) == 0 || r.Content[0] == nil || r.Content[0].Text == nil {
			prompt := retry.BuildRepairPrompt("tools/call:process_batch", "empty MCP tool response", "{\"blob\":\"abc123\",\"format\":\"text\",\"items\":[\"abc123\"],\"mimeType\":\"abc123\",\"uri\":\"abc123\"}", "{\"additionalProperties\":false,\"properties\":{\"blob\":{\"type\":\"string\"},\"format\":{\"enum\":[\"json\",\"text\",\"blob\",\"uri\"],\"type\":\"string\"},\"items\":{\"items\":{\"type\":\"string\"},\"type\":\"array\"},\"mimeType\":{\"type\":\"string\"},\"uri\":{\"type\":\"string\"}},\"required\":[\"items\"],\"type\":\"object\"}")
