	...
	tools := []*ToolInfo{
		{
			...
			InputSchema: json.RawMessage(`{"additionalProperties":false,"properties":{"text":{"type":"string"}},"required":["text"],"type":"object"}`),
		},
		{
		...
		},
		{
			...
			InputSchema: json.RawMessage(`{"additionalProperties":false,"properties":{"code":{"type":"string"},"language":{"enum":["python","javascript"],"type":"string"}},"required":["language","code"],"type":"object"}`),
		},
		{
			Name:        "process_batch",
			Description: stringPtr("Process a batch of items"),
			InputSchema: json.RawMessage(`{"additionalProperties":false,"properties":{"blob":{"type":"string"},"format":{"enum":["json","text","blob","uri"],"type":"string"},"items":{"items":{"type":"string"},"type":"array"},"mimeType":{"type":"string"},"uri":{"type":"string"}},"required":["items"],"type":"object"}`),
		},
	}
